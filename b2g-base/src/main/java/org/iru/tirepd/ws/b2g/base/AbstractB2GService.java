...
public abstract class AbstractB2GService implements TIREPDB2GServiceClassSoap {
	...
	protected abstract void ackMessageContent(Object messageContent, String messageName) throws Exception;
